  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'sahilkrmishra108@gmail.com',
      href: 'mailto:sahilkrmishra108@gmail.com',
      color: 'text-blue-600'
    },
    {
      icon: <Phone className="h-5 w-5" />,
      title: 'Phone',
      value: '+91 8708878446l',
      href: 'tel:+918708878446',
    ...
    },
    {
      ...
      title: 'LinkedIn',
      value: 'sahil-mishra',
      href: 'https://linkedin.com/in/sahil-mishra',
      color: 'text-blue-700'
    },
    {
      ...
      title: 'GitHub',
      value: 'sahilmishra',
      href: 'https://github.com/sahilmishra',
      color: 'text-gray-800'
    },
    {
      ...
      title: 'Instagram',
      value: 'sahilmishra',
      href: 'https://instagram.com/sahilmishra',
      color: 'text-pink-600'
    }
  ];
